...
//  .externalTokenResolver(ITokenResolver)
...
##### `disableResourceNameHashes`<sup>Optional</sup> <a name="org.cdk8s.ChartProps.parameter.disableResourceNameHashes"></a>
...
##### `externalTokenResolver`<sup>Optional</sup> <a name="org.cdk8s.ChartProps.parameter.externalTokenResolver"></a>

- *Type:* [`org.cdk8s.ITokenResolver`](#org.cdk8s.ITokenResolver)
...
##### `externalTokenResolver`<sup>Optional</sup> <a name="org.cdk8s.Chart.property.externalTokenResolver"></a>

```java
public ITokenResolver getExternalTokenResolver();
```
...
##### `disableResourceNameHashes`<sup>Optional</sup> <a name="org.cdk8s.ChartProps.property.disableResourceNameHashes"></a>
...
##### `externalTokenResolver`<sup>Optional</sup> <a name="org.cdk8s.ChartProps.property.externalTokenResolver"></a>
...
### ITokenResolver <a name="org.cdk8s.ITokenResolver"></a>

- *Implemented By:* [`org.cdk8s.ITokenResolver`](#org.cdk8s.ITokenResolver)

#### Methods <a name="Methods"></a>

##### `resolve` <a name="org.cdk8s.ITokenResolver.resolve"></a>

```java
public resolve(java.lang.Object value)
```

###### `value`<sup>Required</sup> <a name="org.cdk8s.ITokenResolver.parameter.value"></a>
