...
cdk8s.Chart(
  ...
  external_token_resolver: ITokenResolver = None,
...
##### `external_token_resolver`<sup>Optional</sup> <a name="cdk8s.ChartProps.parameter.external_token_resolver"></a>
...
##### `external_token_resolver`<sup>Optional</sup> <a name="cdk8s.Chart.property.external_token_resolver"></a>

```python
external_token_resolver: ITokenResolver
```
...
##### `external_token_resolver`<sup>Optional</sup> <a name="cdk8s.ChartProps.property.external_token_resolver"></a>
