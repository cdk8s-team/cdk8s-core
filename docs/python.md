...
cdk8s.Chart(
  scope: Construct,
  id: str,
  enable_resource_name_hashes: bool = None,
...
##### `enable_resource_name_hashes`<sup>Optional</sup> <a name="cdk8s.ChartProps.parameter.enable_resource_name_hashes"></a>
...
##### `enable_resource_name_hashes`<sup>Optional</sup> <a name="cdk8s.ChartProps.property.enable_resource_name_hashes"></a>

```python
enable_resource_name_hashes: bool
```
