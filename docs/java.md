...
//  .enableResourceNameHashes(java.lang.Boolean)
...
##### `enableResourceNameHashes`<sup>Optional</sup> <a name="org.cdk8s.ChartProps.parameter.enableResourceNameHashes"></a>

- *Type:* `java.lang.Boolean`
- *Default:* true

By default the hash of the construct path is suffixed to the autogenerated resource name.
...
##### `enableResourceNameHashes`<sup>Optional</sup> <a name="org.cdk8s.ChartProps.property.enableResourceNameHashes"></a>

```java
public java.lang.Boolean getEnableResourceNameHashes();
```
