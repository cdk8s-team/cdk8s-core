...
### NumberStringUnionResolver <a name="org.cdk8s.NumberStringUnionResolver"></a>
...
#### Initializers <a name="org.cdk8s.NumberStringUnionResolver.Initializer"></a>
...
##### `resolve` <a name="org.cdk8s.NumberStringUnionResolver.resolve"></a>

```java
public resolve(ResolutionContext context)
```

###### `context`<sup>Required</sup> <a name="org.cdk8s.NumberStringUnionResolver.parameter.context"></a>
...
- *Implemented By:* [`org.cdk8s.ImplicitTokenResolver`](#org.cdk8s.ImplicitTokenResolver), [`org.cdk8s.LazyResolver`](#org.cdk8s.LazyResolver), [`org.cdk8s.NumberStringUnionResolver`](#org.cdk8s.NumberStringUnionResolver), [`org.cdk8s.IResolver`](#org.cdk8s.IResolver)
